...
const inputStyle = {
  ...
  fontWeight: 'var(--fw-body)' as const,
  fontSize: '16px',
  color: 'var(--ink)',
  outline: 'none',
      ...
      <main>
        ...
        <section style={{ padding: '40px 48px 120px', display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '80px', alignItems: 'start' }}>
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.3 }}>
            <p style={{ fontFamily: 'var(--font-cormorant)', fontWeight: 'var(--fw-body)', fontSize: '18px', lineHeight: 1.7, opacity: 0.65, marginBottom: '56px', maxWidth: '360px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
              {[
                ...
                <div key={label}>
                  ...
                  {lines.map((line, i) => (
                    <span key={i} style={{ display: 'block', fontFamily: 'var(--font-cormorant)', fontWeight: 'var(--fw-body)', fontSize: '16px', opacity: 0.65, lineHeight: 1.6 }}>{line}</span>
                  ))}
                </div>
              ))}
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.4 }}>
            {submitted ? (
              <div style={{ padding: '64px 0' }}>
                <span style={{ display: 'block', fontFamily: 'var(--font-cormorant)', fontWeight: 'var(--fw-heading)', fontStyle: 'italic', fontSize: '28px', opacity: 0.7 }}>
                  Thank you for reaching out.
                </span>
                <p style={{ fontFamily: 'var(--font-cormorant)', fontWeight: 'var(--fw-body)', fontSize: '16px', opacity: 0.5, marginTop: '16px', lineHeight: 1.7 }}>
