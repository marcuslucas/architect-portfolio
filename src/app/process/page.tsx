  ...
  return (
    <>
      ...
      <main>
        ...
        <section style={{ position: 'relative', padding: '180px 48px 100px', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 2 }}>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
              ...
              <h1 style={{ fontFamily: 'var(--font-heading)', fontWeight: 900, fontSize: 'clamp(40px, 6vw, 72px)', lineHeight: 1.0, letterSpacing: '-0.04em', marginBottom: '28px' }}>
                Process &<br /><em>Philosophy</em>
              </h1>
              <p style={{ fontFamily: 'var(--font-body)', fontWeight: 400, fontSize: '18px', lineHeight: 1.65, opacity: 0.6, maxWidth: '520px' }}>
        ...
        <section style={{ padding: '80px 48px 120px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', background: 'var(--pale)', borderTop: '0.5px solid rgba(26,25,22,0.08)' }}>
          <div>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontStyle: 'italic', fontSize: '32px', lineHeight: 1.2, marginBottom: '28px' }}>On the nature of space</h2>
            <p style={{ fontFamily: 'var(--font-body)', fontWeight: 400, fontSize: '16px', lineHeight: 1.8, opacity: 0.6 }}>
          ...
          <div>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontStyle: 'italic', fontSize: '32px', lineHeight: 1.2, marginBottom: '28px' }}>On Florida architecture</h2>
            <p style={{ fontFamily: 'var(--font-body)', fontWeight: 400, fontSize: '16px', lineHeight: 1.8, opacity: 0.6 }}>
        ...
        {/* CTA */}
        <section style={{ padding: '100px 48px', textAlign: 'center', borderTop: '0.5px solid rgba(26,25,22,0.08)' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontStyle: 'italic', fontSize: 'clamp(28px, 4vw, 52px)', marginBottom: '40px', lineHeight: 1.1, letterSpacing: '-0.02em' }}>
